...
public class MessageReader
{
   ...
   public Message readMessage() throws IOException, DBusException
   {
      ...
      if (len[0] < 12) {
         ...
         if (-1 == rv) throw new EOFException(gt_("Underlying transport returned EOF"));
         len[0] += rv;
      }
      ...
      if (protover > Message.PROTOCOL) {
         buf = null;
         throw new MessageProtocolVersionException(MessageFormat.format(gt_("Protocol version {0} is unsupported"), new Object[] { protover }));
      }
      ...
      switch (type) {
         ...
         case Message.MessageType.ERROR:
            ...
            break;
         default:
            throw new MessageTypeException(MessageFormat.format(gt_("Message type {0} unsupported"), new Object[] {type}));
      }
      if (Debug.debug) {
