...
class ArrayFrob
{
   ...
   public static <T> T[] wrap(Object o) throws IllegalArgumentException
   {
         ...
         if (!ac.isArray()) throw new IllegalArgumentException(gt_("Not an array"));
         Class<? extends Object> cc = ac.getComponentType();
         Class<? extends Object> ncc = primitiveToWrapper.get(cc);
         if (null == ncc) throw new IllegalArgumentException(gt_("Not a primitive type"));
   ...
   public static <T> Object unwrap(T[] ns) throws IllegalArgumentException
   {
      ...
      if (null == ncc) throw new IllegalArgumentException(gt_("Not a wrapper type"));
   ...
   public static <T> List<T> listify(Object o) throws IllegalArgumentException
   {
      ...
      if (!o.getClass().isArray()) throw new IllegalArgumentException(gt_("Not an array"));
   ...
   public static Object convert(Object o, Class<? extends Object> c) throws IllegalArgumentException
   {
      ...
      throw new IllegalArgumentException(MessageFormat.format(gt_("Not An Expected Convertion type from {0} to {1}"), new Object[] { o.getClass(), c}));
   }
