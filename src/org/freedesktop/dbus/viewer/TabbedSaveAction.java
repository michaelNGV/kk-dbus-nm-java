...
abstract class TabbedSaveAction extends AbstractAction implements Iterable<TextFile>
{
	...
	public final void actionPerformed(ActionEvent e)
	{
		...
		chooser.setDialogTitle(gt_("Select parent directory for saving"));
		...
		if (result == JFileChooser.APPROVE_OPTION)
		{
			...
			if (parentDirectory.exists() || parentDirectory.mkdirs())
			{
				...
				{
					JOptionPane.showMessageDialog(tabbedPane, gt_("Could not write to parent directory"), gt_("Invalid Parent Directory"), JOptionPane.ERROR_MESSAGE);
				}
			}
			else
			{
				JOptionPane.showMessageDialog(tabbedPane, gt_("Could not access parent directory"), gt_("Invalid Parent Directory"), JOptionPane.ERROR_MESSAGE);
			}
		}
	}
}
