	...
	private void saveFiles()
	{
		...
		while (iterator.hasNext())
		{
			...
			else
			{
				...
				final String errorMessage = gt_("Could not access parent directory for ")
						+ fileName;
				if (iterator.hasNext())
				{
					...
					int confirm = JOptionPane.showConfirmDialog(parentComponent, errorMessage
									+ ".\n"+gt_("Try saving other files?"),
							gt_("Save Failed"), JOptionPane.OK_CANCEL_OPTION,
							JOptionPane.ERROR_MESSAGE);
					if (confirm != JOptionPane.OK_OPTION)
					{
						break;
				...
				else
				{
					JOptionPane.showMessageDialog(parentComponent, errorMessage
							+ ".", gt_("Save Failed"), JOptionPane.ERROR_MESSAGE);
				}
			}
		}
	}
